...
function generateSnapshot() {
  ...
  customRequire.definitions = {
    "./sample/startup.js": function (exports, module, __filename, __dirname, require, define) {
      function methodInTheSnapshot() {
        get_console().log('Hello, World!!!');
      }
  ...
  customRequire("./sample/startup.js");
  return {
    customRequire,
...
snapshotAuxiliaryData.snapshotSections = [{"relativePath":"./sample/startup.js","startRow":152,"endRow":157}];
